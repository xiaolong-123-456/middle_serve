 ...
 * @date 2024-09-12
 */
public interface OperateMerchantProdectMapper 
{
    /**
     * 查询商户和产品配置详情
     * 
     ...
     * @return 结果
     */
    public List<OperateMerchantProdect> selectMchProList(Map<String, Object> params);
     ...
     * @return 结果
     */
    int updateByMchPro(Map<String, Object> params);
     ...
     * @return 结果
     */
    int updateByMchIdPro(Map<String, Object> params);
